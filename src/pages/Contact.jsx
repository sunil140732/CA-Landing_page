  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-12 text-center text-lg">
        ...
        <p>Email: <a href="mailto:contact@charteredfinders.com" className="text-blue-500">sunilvadlamudi07@gmail.com</a></p>
        <p>Phone: <span className="text-blue-500">+91-9652861548</span></p>
      </div>
    </div>
  );
};
